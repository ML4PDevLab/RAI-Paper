...
file_path_chn <- here("data", "wetransfer_monthly-data_2024-05-18_0927", 
                      "FAI_GKG (12M) - China-Country2 dyads - all media.xlsx")
file_path_rus <- here("data", "wetransfer_monthly-data_2024-05-18_0927", 
                      "FAI_GKG (12M) - Russia-Country2 dyads - all media.xlsx")
...
ggsave(here::here("writing/output/corr_all.png"), height = 5, width = 7, dpi = 700)
...
ggsave(here::here("writing/output/corr_facet.png"), height = 5, width = 7, dpi = 700)
