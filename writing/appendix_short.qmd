...
read_rai <- function() {
  # Check both project-root and writing-local paths so renders work from either cwd.
  candidates <- c(
    Sys.getenv("RAI_LATEST_CSV", unset = ""),
    "writing/output/rai_latest.csv",
    "output/rai_latest.csv",
    "data/rai_latest.csv",
    "../data/rai_latest.csv",
...
# Keep plots readable by showing only the top-N countries by peak activity
select_top_countries <- function(df, value_col, n = 12) {
  df %>%
    group_by(country) %>%
    summarise(mx = max(.data[[value_col]], na.rm = TRUE), .groups = "drop") %>%
    arrange(desc(mx)) %>%
    slice_head(n = n) %>%
    pull(country)
}
...
- **Foreign Investment:** Articles reporting on efforts by individuals, businesses, or government bodies from one country to make large financial investments in the private or public sector of another country. This can also refer to the refusal or withdrawal of such investments.
...
## Using Keywords to Detect Influence 
...
-  Contains one or more keywords in the *main text*
...
surgestable <- data.frame(
  Country = c(
    "Guatemala", "Guatemala", "Guatemala", "Pakistan",
    "DR Congo","DR Congo","DR Congo","Moldova","Moldova","Moldova",
    "Dominican Republic","Dominican Republic","Dominican Republic","Philippines",
    "Uganda","Uganda","Uganda","Kosovo","Kosovo","Kosovo",
    "Malaysia","Malaysia","Malaysia","Ukraine","Ukraine","Ukraine",
    "Ghana","Ghana","Ghana","Albania","Albania","Albania",
    "Tunisia","Tunisia","Tunisia","Paraguay","Paraguay","Paraguay",
    "Kenya","Kenya","Kenya","Colombia","Colombia","Colombia",
    "Cambodia","Cambodia","Cambodia",
    "Dominican Republic","Dominican Republic","Dominican Republic",
    "Peru","Peru","Peru","Zambia","Zambia","Zambia",
    "Azerbaijan","Azerbaijan","Azerbaijan", 
    "Burkina Faso","Burkina Faso","Burkina Faso",
    "Costa Rica","Costa Rica","Costa Rica","Turkey","Turkey","Turkey",
    "Tanzania","Kosovo","Kosovo","Kosovo",
    "Kenya","Kenya","Ethiopia","Ethiopia","Ethiopia",
    "Georgia","Georgia","Georgia","India","India","India",
    "Armenia","Armenia","Armenia","Belarus","Belarus","Belarus",
    "Cameroon","Cameroon","Cameroon","Ecuador","Ecuador","Ecuador",
    "El Salvador","El Salvador","El Salvador","Hungary","Hungary","Hungary",
    "Indonesia","Indonesia","Indonesia","Jamaica","Jamaica","Jamaica",
    "Algeria","Algeria","Algeria","Bangladesh","Bangladesh","Bangladesh"
  ),
  Event_Type = c(
    "military_activity", "military_activity","military_activity","military_activity",
    "diplomatic_mediation","diplomatic_mediation","diplomatic_mediation",
    "diplomatic_mediation","diplomatic_mediation", "diplomatic_mediation",
    "foreign_aid_assistance","foreign_aid_assistance","foreign_aid_assistance",
    "foreign_aid_assistance",
    "intelligence_counterintelligence","intelligence_counterintelligence",
    "intelligence_counterintelligence","intelligence_counterintelligence",
    "intelligence_counterintelligence","intelligence_counterintelligence",
    "cyber_attack","cyber_attack","cyber_attack","cyber_attack","cyber_attack",
    "cyber_attack",
    "foreign_investment","foreign_investment","foreign_investment",
    "foreign_investment","foreign_investment","foreign_investment",
    "trade_financial_sanction","trade_financial_sanction","trade_financial_sanction",
    "trade_financial_sanction","trade_financial_sanction","trade_financial_sanction",
    "political_process_policy_intervention","political_process_policy_intervention",
    "political_process_policy_intervention","political_process_policy_intervention",
    "political_process_policy_intervention","political_process_policy_intervention",
    "social_academic_cultural_activity","social_academic_cultural_activity",
    "social_academic_cultural_activity","social_academic_cultural_activity",
    "social_academic_cultural_activity","social_academic_cultural_activity",
    "tech_transfer_investment","tech_transfer_investment","tech_transfer_investment",
    "tech_transfer_investment","tech_transfer_investment","tech_transfer_investment",
    "joint_security_force_exercise","joint_security_force_exercise",
    "joint_security_force_exercise","joint_security_force_exercise",
    "joint_security_force_exercise","joint_security_force_exercise",
    "diplomatic_action","diplomatic_action","diplomatic_action",
    "diplomatic_action","diplomatic_action","diplomatic_action",
    "cyber_attack","cyber_attack","cyber_attack","cyber_attack",
    "bribery_economic_corruption","bribery_economic_corruption",
    "bribery_economic_corruption","bribery_economic_corruption",
    "bribery_economic_corruption",
    "foreign_investment","foreign_investment","foreign_investment",
    "foreign_investment","foreign_investment","foreign_investment",
    "arms_transfer_security_aid_assistance","arms_transfer_security_aid_assistance",
    "arms_transfer_security_aid_assistance","arms_transfer_security_aid_assistance",
    "arms_transfer_security_aid_assistance","arms_transfer_security_aid_assistance",
    "media_campaign_intervention","media_campaign_intervention",
    "media_campaign_intervention","media_campaign_intervention",
    "media_campaign_intervention","media_campaign_intervention",
    "security_engagement","security_engagement","security_engagement",
    "security_engagement","security_engagement","security_engagement", 
    "transnational_organization_crime","transnational_organization_crime",
    "transnational_organization_crime","transnational_organization_crime",
    "transnational_organization_crime","transnational_organization_crime",
    "diplomatic_ties","diplomatic_ties","diplomatic_ties",
    "diplomatic_ties","diplomatic_ties","diplomatic_ties"
  ),
  Date_of_Surge = c(
    "2015-10", "2022-02", "2022-03", "2018-11",
    "2023-05","2023-06","2022-03","2025-03","2012-01","2023-04",
    "2018-11","2020-04","2018-05","2013-11",
    "2014-03","2019-08","2021-07","2022-08","2013-04","2019-11",
    "2018-08","2015-04","2014-08","2025-10","2022-01","2018-02",
    "2018-09","2017-07","2012-09","2012-05","2014-09","2014-06",
    "2012-09","2013-03","2024-07","2012-06","2018-04","2022-02",
    "2023-02","2022-12","2019-12","2022-03","2018-01","2018-02",
    "2025-04","2024-05","2023-12","2018-05","2019-04","2019-01",
    "2025-08","2021-02","2021-03","2016-05","2024-10","2019-04",
    "2021-01","2017-02","2014-04","2023-09","2022-04","2022-02",
    "2023-01","2013-09","2024-09","2025-06","2025-08","2025-05",
    "2017-07","2016-08","2020-05","2024-05",
    "2018-11","2016-04","2014-11","2017-09","2023-01",
    "2012-03","2012-05","2024-11","2015-05","2016-10","2014-09",
    "2016-04","2015-07","2019-02","2023-06","2023-05","2022-06",
    "2019-10","2015-12","2025-03","2019-06","2022-11","2019-04",
    "2018-08","2022-03","2018-09","2015-03","2024-02","2023-07",
    "2019-03","2017-07","2017-04","2019-09","2020-06","2017-10",
    "2023-06","2023-07","2024-07","2024-07","2024-01","2014-10"
  )
)

surgestable <- surgestable |>
  mutate(Event_Type = gsub("_", " ", Event_Type))
...
kable(
  ...
  longtable = TRUE,
  align = c("l", "l", "c"),
  col.names = c("Country", "Event type", "Date of surge"),
  caption = "Country-Event Surges Evaluated"
) |>
  kable_styling(
...
As an alternative visualization, we break our data into three historical periods: 2012-2016, 2017-2021, and 2022-2025 (through August 2025). This provides two five-year windows at the beginning of our series followed by a smaller snapshot of the very recent past. 2012-2016 includes Russia's annexation of Crimea, 2017-2021 includes the onset of the COVID-19 pandemic, and 2022-2025 includes Russia's invasion of Ukraine and its aftermath. @fig-plot_dominant-theme provides a visualization of themes at the monthly-level.
...
x_min <- min(dfp$percentage_change, na.rm = TRUE)
x_max <- max(dfp$percentage_change, na.rm = TRUE)

dfp |>
  mutate(country = factor(country, levels =  unique(dfpr$country))  ) |>
  ggplot(aes(x = percentage_change, y = country ) ) + 
  geom_line(aes(group = country), color = "gray80", alpha = 0.6) +
  geom_point(aes(color = period), size = 1.6, alpha = 0.85) +
  ...
  theme_bw() +
  scale_x_continuous(labels = scales::percent_format( scale=1 ), limits = c(x_min, x_max),
  ...
  scale_color_manual("Percent change between time\nperiods", 
                       labels = c("2012-2016 and 2017-2021", "2017-2021 and 2022-2025"),
...
# cor(dfp[dfp$period == "2022-2025",]$percentage_change, dfp[dfp$period == "2022-2025",]$mean_total_rai, use = "complete.obs")
# cor(dfp[dfp$period == "2022-2025" & dfp$influencer == "Russia",]$percentage_change, dfp[dfp$period == "2022-2025" & dfp$influencer == "Russia",]$mean_total_rai)
...
rc1 = cor(dfp[dfp$period == "2022-2025" & dfp$influencer == "Russia",]$percentage_change, dfp[dfp$period == "2017-2021" & dfp$influencer == "Russia",]$mean_total_rai)
...
rc2 = cor(dfp_c_share[dfp_c_share$period == "2022-2025" & dfp_c_share$influencer == "Russia",]$percentage_change, dfp_c_share[dfp_c_share$period == "2017-2021" & dfp_c_share$influencer == "China",]$c_share)

rc3 = cor(dfp[dfp$period == "2022-2025" & dfp$influencer == "Russia",]$percentage_change, dfp[dfp$period == "2022-2025" & dfp$influencer == "China",]$percentage_change)
...
rai_df <- rai_df |>
  ...
  filter(influencer != "Combined") |>
  filter(country != "Timor Leste") |>
  mutate(article_total = replace_na(article_total, 0),
         rai_idx_total_raw = (rai_idx_total * article_total) / 10000) |>
  group_by(influencer, date) |>
  summarize(rai_idx_total_raw = (sum(rai_idx_total_raw, na.rm = TRUE) / sum(article_total, na.rm = TRUE)) * 10000,
            .groups = "drop")
...
df <- read_rai() |>
  filter(! influencer=="Combined") |>
  select(country, date, rai_idx_total, influencer, article_total)

all_dates <- seq(min(df$date, na.rm = TRUE), rai_end_date, by = "1 month")

df <- df |>
  tidyr::complete(country, influencer, date = all_dates,
                  fill = list(rai_idx_total = 0, article_total = 0)) |>
  mutate(article_total = replace_na(article_total, 0)) |>
  mutate(period = case_when(
    date < "2017-01-01" ~ "2012-2016",
    date >= "2017-01-01" & date < "2022-01-01" ~ "2017-2021",
...
df <- df |>
  group_by(country, period, influencer) |>
  summarize(value = sum( rai_idx_total, na.rm = TRUE ) ,
            article_total = sum(article_total, na.rm = TRUE),
              .groups = "drop") |>
...
To identify commodities on which Russia is import-reliant, we focus on commodities that constitute a meaningful share of Russia's overall trade and which Russia cannot produce domestically. Commodities must meet two criteria. First, we focus on commodities that constitute at least 0.01% of the value of all Russian trade (exports + imports) from 2015-2023. Second, we require that more than 65% of Russia's total trade in a given commodity comes from imports. Empirically, a low ratio of exports to imports indicates a limited ability to produce the commodity domestically [@saltarelli2020export]. 

![Commodities on which Russia is import-reliant](import_reliance_heading.png){#fig-import_reliance_heading fig-align="center"}

We consider Russia to be import-reliant on commodities that meet both criteria. @fig-import_reliance_heading plots these commodities. Labeled points correspond with the top product under each commodity-heading.

{{< pagebreak >}}

### Import Reliance Exporters

Next, we identify countries that export commodities on which Russia is import-reliant, referred to as *Import Reliance Exporters (IREs)*. A country qualifies as an *IRE* if, for at least one commodity on which Russia is import-reliant, the value of the country's total exports exceeds 100% of the value of Russia’s total imports of that commodity, and the country exports at least 20 distinct import-reliance commodities. This ensures that the country has a substantial supply across multiple commodities on which Russia is heavily dependent. @fig-import_reliance_heading_exporters plots countries that qualify as *IREs*. Our current sample includes 9 countries in Africa, 4 in the Americas, 7 in Asia, and 5 in Europe.
...
Finally, we identify countries that are import-reliant on commodities on which Russia is export reliant, which we term *Export Reliance Importers (ERIs)*. A country qualifies as an *ERI* if it is import-reliant on at least 5 distinct commodities for which Russia is export-reliant and its imports of commodities for which Russia is export-reliant are worth at least 5 billion constant 2015 US Dollars. This ensures that countries are reliant on a broad range of key Russian exports that constitute a significant share of the country’s overall trade portfolio. @fig-export_reliance_heading_importers plots countries that qualify as *ERIs*. Our current sample includes 6 countries in Africa, 2 in the Americas, 6 in Asia, and 2 in Europe.
...
#| fig-cap: "Timing of changepoint dates in Russian influence time-series for the top 12 countries by peak Diplomacy reporting. Red points mark the identified change-point for each country."
...
top_countries <- select_top_countries(dip, "rai_idx_dip", n = 12)
dip <- dip %>% filter(country %in% top_countries)

max_date <- max(rai_df$date, na.rm = TRUE)
if (!is.finite(max_date)) {
  max_date <- max(read_rai()$date, na.rm = TRUE)
}
...
#| fig-cap: "Timing of changepoint dates in Russian influence time-series for the top 12 countries by peak Hard Power reporting. Red points mark the identified change-point for each country."
...
top_countries <- select_top_countries(dip, "rai_idx_hp", n = 12)
dip <- dip %>% filter(country %in% top_countries)
...
#| fig-cap: "Timing of changepoint dates in Russian influence time-series for the top 12 countries by peak Economic Power reporting. Red points mark the identified change-point for each country."
...
top_countries <- select_top_countries(dip, "rai_idx_ep", n = 12)
dip <- dip %>% filter(country %in% top_countries)
...
#| fig-cap: "Timing of changepoint dates in Russian influence time-series for the top 12 countries by peak Domestic Interference reporting. Red points mark the identified change-point for each country."
...
top_countries <- select_top_countries(dip, "rai_idx_di", n = 12)
dip <- dip %>% filter(country %in% top_countries)
...
#| fig-cap: "Timing of changepoint dates in Russian influence time-series for the top 12 countries by peak Soft Power reporting. Red points mark the identified change-point for each country."
...
top_countries <- select_top_countries(dip, "rai_idx_sp", n = 12)
dip <- dip %>% filter(country %in% top_countries)
...
# Compute rc_list for figures 6 and 7
df_rc <- read_rai() |>
  filter(country != "Timor Leste") |>
  select(country, date, rai_idx_total, influencer) |>
  filter(! influencer=="Combined")

rai_end_date_rc <- as.Date("2025-08-01")
all_dates_rc <- seq(min(df_rc$date, na.rm = TRUE), rai_end_date_rc, by = "1 month")

dfp_rc <- df_rc |>
  tidyr::complete(country, influencer, date = all_dates_rc,
                  fill = list(rai_idx_total = 0)) |>
  mutate(period = case_when(
...
rc1 = cor(
  dfp_rc[dfp_rc$period == "2022-2025" & dfp_rc$influencer == "Russia",]$percentage_change, 
  dfp_rc[dfp_rc$period == "2012-2021" & dfp_rc$influencer == "Russia",]$mean_total_rai)

dfp_c_share_rc <- dfp_rc |>
  arrange(country, period) |>
  group_by(country, period) |>
  mutate(c_share = mean_total_rai[1] / (mean_total_rai[1] + mean_total_rai[2]))

rc2 = cor(
  dfp_c_share_rc[dfp_c_share_rc$period == "2022-2025" & dfp_c_share_rc$influencer == "Russia",]$percentage_change,
  dfp_c_share_rc[dfp_c_share_rc$period == "2012-2021" & dfp_c_share_rc$influencer == "China",]$c_share)

rc3 = cor(
  dfp_rc[dfp_rc$influencer == "Russia",]$percentage_change,
  dfp_rc[dfp_rc$influencer == "China",]$percentage_change, use = "complete.obs")

rc_list = lapply(c(rc1, rc2, rc3), round, digits = 2)
rm(rc1, rc2, rc3, dfp_c_share_rc)
```

## Absolute and Country-Level Change in Influence Activity
...
Next, we trained a neural network model to detect spikes using a human-labeled dataset covering the full time-series for 30 country-event pairs. We conducted human-labeling by asking humans to identify months with visually distinct, sharp increases in our event measures. Human labelers were instructed to identify no more than 15% of overall months as shocks, ensuring that peaks are not overly frequent in highly variable data while still capturing meaningful shifts in lower-variance event types. When either the statistical or neural network model detects a shock, we label that month as a shock in the data. Finally, given the small number of RAI articles in any given month for some countries with low-volume, we recode any surge that occurs as a result of 2 or fewer monthly articles as zero.
